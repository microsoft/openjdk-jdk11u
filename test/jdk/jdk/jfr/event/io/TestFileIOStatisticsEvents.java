...
public class TestFileIOStatisticsEvents { 
    ...
    private static final byte[] writeBuf = { 'B','C','D','E' ,'F' ,'G' ,'H' ,'I' ,'J' ,'K' ,'L' };
    ...
    public static void main(String[] args) throws Throwable {        
        ...
        recording.enable(EventNames.FileReadIOStatistics).withPeriod(Duration.ofMillis(1));         
        recording.start();       
        useFileWriter(tmp);              
    ...
    private static void useFileWriter(File tmp) throws Throwable{                     
               
        try (FileWriter writer = new FileWriter(tmp)) {                    
            writer.write(message);             
            accWriteExpected =  accWriteExpected + message.length();  
    ...
    private static void checkForEventAttributesEnabled(Recording recording) throws Throwable
    {
        ...
        assertGreaterThanOrEqual(Integer.parseInt(accWrite), accWriteExpected, "The accumulated write bytes should be equal or more that expected length");
        assertGreaterThanOrEqual(Integer.parseInt(accRead), accReadExpected, "The accumulated write bytes should be equal or more that expected length");
    }
}
